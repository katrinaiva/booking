...
// CSS
__webpack_require__(/*! ./scss/styles.scss */ 16);

//JS
//bootstrap vendors
__webpack_require__(/*! jquery */ 0);
__webpack_require__(/*! slick-carousel */ 6);
__webpack_require__(/*! jquery-validation */ 2);
__webpack_require__(/*! jquery-validation/dist/additional-methods */ 7);
__webpack_require__(/*! jquery-validation-unobtrusive */ 8);

__webpack_require__(/*! bootstrap */ 9);

//bootstrap pcg app
__webpack_require__(/*! ./js/extensions/jquery.extensions */ 11);
__webpack_require__(/*! ./js/extensions/jquery.validation.extensions */ 12);
__webpack_require__(/*! ./js/pcg.frontend */ 13).init();
...
(function () {
    ...
    $.validator.addMethod("accept", function (value, element, accept) {
        ...
        if ($(element).attr("type") === "file") {
            ...
            typeParam = accept.replace(/[\-\[\]\/\{\}\(\)\+\?\.\\\^\$\|]/g, "\\$&").replace(/,/g, "|").replace(/\/\*/g, "/.*");
...
var AccessWidget = __webpack_require__(/*! ./controls/access.widget */ 14);
var HomeSlick = __webpack_require__(/*! ./controls/homeslick */ 15);
